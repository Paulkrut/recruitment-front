    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      <Paper elevation={3} sx={{ p: 4 }}>
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>Настоящие Условия использования (далее — «Условия») регулируют порядок использования системы подбора персонала SofiHR (далее — «Система») и определяют права и обязанности пользователей.</Typography>
          <Typography variant="body1" paragraph>Используя Систему, вы принимаете настоящие Условия и соглашаетесь следовать им.</Typography>
        </Box>
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>Система предоставляет следующие возможности:</Typography>
          <List>
            <ListItem>
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>При использовании Системы запрещается:</Typography>
          <List>
            <ListItem>
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>Пользователи обязаны:</Typography>
          <List>
            <ListItem>
              <ListItemIcon><CheckCircle color="success" /></ListItemIcon>
              <ListItemText 
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>Система предоставляется «как есть» без каких-либо гарантий:</Typography>
          <List>
            <ListItem>
              <ListItemIcon><Warning color="warning" /></ListItemIcon>
              <ListItemText 
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>Все права на Систему принадлежат разработчикам:</Typography>
          <List>
            <ListItem>
          ...
          <Typography variant="body1" paragraph>Пользователи не имеют права копировать, модифицировать или распространять элементы Системы без разрешения.</Typography>
        </Box>
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>Система обеспечивает конфиденциальность данных:</Typography>
          <List>
            <ListItem>
              <ListItemIcon><CheckCircle color="success" /></ListItemIcon>
              <ListItemText 
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>Мы оставляем за собой право изменять настоящие Условия:</Typography>
          <List>
            <ListItem>
              <ListItemIcon><Info color="info" /></ListItemIcon>
              <ListItemText 
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>Использование Системы может быть прекращено:</Typography>
          <List>
            <ListItem>
              <ListItemIcon><Warning color="warning" /></ListItemIcon>
              <ListItemText 
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>Настоящие Условия регулируются законодательством Российской Федерации. Все споры разрешаются в соответствии с российским правом.</Typography>
          <Typography variant="body1" paragraph>В случае возникновения разногласий стороны обязуются решать их путем переговоров. При невозможности достижения соглашения спор разрешается в судебном порядке.</Typography>
        </Box>
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>По всем вопросам, связанным с использованием Системы:</Typography>
          <List>
            <ListItem>
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>Настоящие Условия вступают в силу с момента размещения на сайте и действуют до момента их отмены или замены новыми Условиями.</Typography>
          <Typography variant="body1" paragraph>Используя Систему, вы подтверждаете, что ознакомились с настоящими Условиями и согласны следовать им.</Typography>
        </Box>
        ...
        <Alert severity="info" sx={{ mt: 4 }}>
          <Typography variant="body2">
            <strong>Важно:</strong> Данные условия использования составлены в соответствии с российским законодательством. При возникновении вопросов обращайтесь к нам.
          </Typography>
        </Alert>
      </Paper>
    </Container>
