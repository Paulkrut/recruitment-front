    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      <Paper elevation={3} sx={{ p: 4 }}>
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>Ваши персональные данные НЕ передаются третьим лицам, за исключением случаев:</Typography>
          <List>
            <ListItem>
              <ListItemIcon><Info color="info" /></ListItemIcon>
              <ListItemText
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>Для транскрибации аудио и вспомогательной обработки оператор привлекает обработчиков по поручению на территории РФ. Обработка осуществляется строго по инструкциям оператора, без использования данных в целях обучения, с ограниченными сроками хранения и без трансграничной передачи.</Typography>
          <List>
            <ListItem>
              <ListItemIcon><CheckCircle color="success" /></ListItemIcon>
              <ListItemText
