    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      <Paper elevation={3} sx={{ p: 4 }}>
        ...
        <Box textAlign="center" mb={4}>
          ...
          <Typography variant="h3" gutterBottom fontWeight="bold">Политика конфиденциальности</Typography>
          <Typography variant="h6" color="text.secondary">Обработка персональных данных в системе подбора персонала</Typography>
          <Chip
            label="Обновлено: 16.03.2026"
            color="primary"
            sx={{ mt: 2 }}
          />
        </Box>
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>Настоящая Политика конфиденциальности (далее — «Политика») определяет порядок обработки
            ...
            «О персональных данных» (далее — «152-ФЗ»).</Typography>
          <Typography variant="body1" paragraph>Используя Систему, вы даете согласие на обработку ваших персональных данных
            в соответствии с настоящей Политикой.</Typography>
        </Box>
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>Оператором персональных данных является Индивидуальный предприниматель Филипенко Анна Евгеньевна (ОГРНИП 324774600106007, ИНН 772154932804).</Typography>
          ...
          <Typography variant="body2" color="text.secondary" paragraph>Обработка и хранение персональных данных осуществляются на территории Российской Федерации; трансграничная передача не осуществляется.</Typography>
        </Box>
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>Ваши персональные данные обрабатываются исключительно в следующих целях:</Typography>
          <List>
            <ListItem>
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>Система обрабатывает следующие категории персональных данных:</Typography>
          <List>
            <ListItem>
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>Обработка персональных данных осуществляется на следующих основаниях:</Typography>
          <List>
            <ListItem>
              <ListItemIcon><CheckCircle color="success" /></ListItemIcon>
              <ListItemText
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>Мы храним ваши персональные данные только в течение времени, необходимого
            для достижения целей обработки, указанных в настоящей Политике.</Typography>

          <Typography variant="h6" gutterBottom fontWeight={600} sx={{ mt: 3 }}>Конкретные сроки хранения:</Typography>
          <List>
            <ListItem>
              <ListItemIcon><Info color="info" /></ListItemIcon>
              <ListItemText
          ...
          <Typography variant="body1" paragraph sx={{ mt: 2 }}>По истечении указанных сроков все персональные данные подлежат
            автоматическому удалению или обезличиванию.</Typography>
          <Alert severity="info" sx={{ mt: 2 }}>
            Для бесплатных HR-инструментов содержимое текстов и файлов, переданное
            пользователем для разовой генерации результата, по общему правилу не
            предназначено для постоянного хранения оператором. При этом могут
            сохраняться технические метаданные использования, а сами данные могут
            кратковременно обрабатываться во временных файлах, очередях и памяти
            систем, если это необходимо для выполнения запроса, безопасности или
            диагностики сбоев.
          </Alert>
        </Box>
        ...
        <Box mb={4}>
          <Typography variant="h5" gutterBottom fontWeight="bold" color="primary">
            ...
            7. Обработка видео и аудио данных
          </Typography>
          <Typography variant="body1" paragraph>В процессе прохождения интервью система может записывать видео и аудио кандидата. Эти данные не используются для установления личности; биометрические шаблоны (слепки голоса/лица) не формируются.</Typography>

          <Typography variant="h6" gutterBottom fontWeight={600} sx={{ mt: 3 }}>Цели обработки видео и аудио данных:</Typography>
          <List>
            <ListItem>
              <ListItemIcon><CheckCircle color="success" /></ListItemIcon>
              <ListItemText
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>В соответствии с Федеральным законом "О персональных данных" вы имеете следующие права:</Typography>
          ...
          <Typography variant="body1" paragraph sx={{ mt: 2 }}>Для реализации своих прав обращайтесь к нам через форму обратной связи
            или по указанным контактным данным.</Typography>
        </Box>
        ...
        <Box mb={4}>
          ...
          <Typography variant="h6" gutterBottom fontWeight={600} sx={{ mt: 3 }}>Типы HR-клиентов платформы:</Typography>
          <List>
            <ListItem>
              <ListItemIcon><CheckCircle color="success" /></ListItemIcon>
              <ListItemText
          ...
          <Typography variant="h6" gutterBottom fontWeight={600} sx={{ mt: 3 }}>Как работает платформа:</Typography>
          <List>
            <ListItem>
              <ListItemIcon><CheckCircle color="success" /></ListItemIcon>
              <ListItemText
          ...
          <Typography variant="h6" gutterBottom fontWeight={600} sx={{ mt: 3 }}>Двойная обработка данных:</Typography>
          <List>
            <ListItem>
              <ListItemIcon><Info color="info" /></ListItemIcon>
              <ListItemText
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>Для защиты ваших персональных данных применяются следующие меры:</Typography>
          <List>
            <ListItem>
              <ListItemIcon><CheckCircle color="success" /></ListItemIcon>
              <ListItemText
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>Ваши персональные данные могут передаваться третьим лицам только в объеме, необходимом для достижения целей обработки, и при наличии законного основания. Это возможно в следующих случаях:</Typography>
          <List>
            <ListItem>
              <ListItemIcon><Info color="info" /></ListItemIcon>
              <ListItemText
                primary="С вашего явного согласия"
                secondary="Когда согласие требуется в силу закона или характера обрабатываемых данных"
              />
            </ListItem>
            <ListItem>
              <ListItemIcon><Info color="info" /></ListItemIcon>
              <ListItemText
                primary="Российским технологическим партнерам и обработчикам по поручению"
                secondary="Для работы AI-функций, транскрибации, генерации документов, распознавания речи, технической поддержки и защиты сервиса"
              />
            </ListItem>
            <ListItem>
              <ListItemIcon><Info color="info" /></ListItemIcon>
            ...
            <ListItem>
              ...
              <ListItemText
                ...
                secondary="При расследовании инцидентов, злоупотреблений или нарушений работы сервиса"
              />
            </ListItem>
          </List>
        </Box>
        ...
        <Box mb={4}>
          <Typography variant="h5" gutterBottom fontWeight="bold" color="primary">
            <Info sx={{ mr: 1, verticalAlign: 'middle' }} />
            11.1. Обработчики по поручению
          </Typography>
          <Typography variant="body1" paragraph>Для работы платформы и бесплатных HR-инструментов оператор вправе привлекать российских технологических партнеров и обработчиков по поручению, включая провайдеров облачной инфраструктуры, сервисов распознавания речи, языковых моделей, генерации текста и технических уведомлений. Такая обработка осуществляется по поручению оператора, в объеме, необходимом для оказания услуги, и в соответствии с требованиями 152-ФЗ.</Typography>
          <List>
            <ListItem>
              <ListItemIcon><CheckCircle color="success" /></ListItemIcon>
              <ListItemText
                primary="Российские AI- и speech-провайдеры"
                secondary="Используются для транскрибации, улучшения текста, генерации документов и других результатов по запросу пользователя"
              />
            </ListItem>
            <ListItem>
              <ListItemIcon><CheckCircle color="success" /></ListItemIcon>
              <ListItemText
                primary="Российские инфраструктурные и сервисные подрядчики"
                secondary="Могут обрабатывать технические метаданные, временные файлы и служебные уведомления для работы и защиты сервиса"
              />
            </ListItem>
          </List>
          <Alert severity="info" sx={{ mt: 2 }}>
            Актуальный перечень технологических партнеров может меняться без отдельного уведомления пользователя, если цели обработки, категория обрабатываемых данных и правовой режим их защиты остаются сопоставимыми и соответствуют законодательству РФ.
          </Alert>
          <Typography variant="body2" color="text.secondary" sx={{ mt: 2 }}>
            Для отдельных функций, включая транскрибацию, оператор может формировать
            внутренние служебные уведомления о факте использования инструмента
            и его технических параметрах без передачи полного содержимого результата.
          </Typography>
        </Box>
        ...
        <Box mb={4}>
          <Typography variant="h5" gutterBottom fontWeight="bold" color="primary">
            <Info sx={{ mr: 1, verticalAlign: 'middle' }} />
            12. Cookies и аналитические данные
          </Typography>
          <Typography variant="body1" paragraph>Система использует cookies для:</Typography>
          <List>
            <ListItem>
              <ListItemIcon><Info color="info" /></ListItemIcon>
              <ListItemText
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>Мы оставляем за собой право вносить изменения в настоящую Политику.
            При внесении существенных изменений:</Typography>
          <List>
            <ListItem>
              <ListItemIcon><CheckCircle color="success" /></ListItemIcon>
              <ListItemText
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>По всем вопросам, связанным с обработкой персональных данных, обращайтесь:</Typography>
          <List>
            <ListItem>
              <ListItemIcon><ContactSupport color="primary" /></ListItemIcon>
              <ListItemText
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" paragraph>Настоящая Политика вступает в силу с момента размещения на сайте и действует
            до момента ее отмены или замены новой Политикой.</Typography>
          <Typography variant="body1" paragraph>Используя Систему, вы подтверждаете, что ознакомились с настоящей Политикой
            и согласны с условиями обработки ваших персональных данных.</Typography>
        </Box>
        ...
        <Box textAlign="center" mt={4}>
          ...
          <Button
            ...
            href="/forget-me"
            sx={{ mr: 2 }}
          >Запрос на удаление данных</Button>
          <Button
            variant="outlined"
            color="info"
            size="large"
            component={Link}
            href="/hr-agreement"
          >Соглашение для HR-клиентов</Button>
        </Box>
